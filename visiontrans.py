...
default_detect= ["FACE", "LABEL", "LOGO", "TEXT"]
default_max   = 3
...
def main(detect="", photo_file="", trans_lan="ja-JP"):
    ...
    with open(photo_file, 'rb') as image:
        ...
        if trans_lang == "ja-JP":
          os.system(dir_aquest + '/AquesTalkPi -g {} {} | aplay -D plughw:{},{}'.format(VOLUME, trans_result, CARD, DEVICE))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--trans', nargs='?', default='ja-JP', help='Translation language')
